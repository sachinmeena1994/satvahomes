  ...
  return (
    <div className="flex flex-row w-full border-opacity-50 h-screen">
      ...
      >
        <ul className="mt-4">
          <li
            className={`cursor-pointer py-2 px-4 rounded-lg mb-2 duration-200 ${
          ...
          <li
            className={`cursor-pointer py-2 px-4 duration-200 rounded-lg mb-2 ${
                ...
                >
                  ...
                  <div className="bg-gray-100 flex gap-2 items-center p-4 mb-4 rounded-lg">
                    ...
                    <div className="flex items-center">
                      <div className="pl-2 border border-zinc-200 rounded mr-2 bg-white">
                        <select
                          className="rounded-md py-2 pb-2 px-2 mr-4 border-none outline-none"
                          value={user.role}
                      ...
                      <button
                        className="bg-[#0e6d55e1] text-white px-4 py-2 duration-300 rounded hover:bg-green-900 outline-none"
